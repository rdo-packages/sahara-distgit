...
# (FIXME) there is an issue that has been fixed after rc1
# in https://review.openstack.org/#/c/493670/ . Following line
# can be removed for following builds.
...
%changelog
* Tue Apr 16 2019 RDO <dev@lists.rdoproject.org> 1:7.0.4-1
- Update to 7.0.4
...
* Mon Aug 21 2017 Alfredo Moralejo <amoralej@redhat.com> 1:7.0.0-0.1.0rc1
